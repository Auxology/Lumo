...
internal sealed class LoginVerifiedConsumer(
    INotificationDbContext notificationDbContext,
    IDateTimeProvider dateTimeProvider,
    ILogger<LoginRequestedConsumer> logger) : IConsumer<LoginVerified>
{
    public async Task Consume(ConsumeContext<LoginVerified> context)
    {
