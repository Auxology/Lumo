...
internal sealed class Endpoint : Endpoint<Request>
{
    ...
    public override void Configure()
    {
        ...
        Description(d =>
        {
            d.WithSummary("Stream Ephemeral Chat Response")
                .WithDescription(
                    "Server-Sent Events endpoint for streaming AI responses in ephemeral chats. " +
                    "Requires streamId query parameter from StartEphemeralChat response. " +
